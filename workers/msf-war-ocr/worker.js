...
function buildGeminiPrompt(alliance) {
  ...
  return [
    ...
    "- Évalue chaque ligne de joueur INDÉPENDAMMENT et prends la décision ligne par ligne.",
    "- Le fait qu'une ligne soit tronquée ne doit JAMAIS influencer les autres lignes.",
    "- N'ajoute jamais un 0 par cohérence avec une autre ligne du tableau.",
    "- Si une seule ligne présente une troncature visible, corrige uniquement cette ligne.",
    "- Une valeur visible inférieure à 1 000 000 000 ne doit JAMAIS recevoir un 0 final.",
    "- Si la valeur affichée semble complète, retourne exactement les chiffres visibles, sans multiplication implicite par 10.",
    "- En cas de doute sur la présence d'une troncature, n'ajoute pas de 0.",
    "- Exemples complets sans zéro ajouté : 666 581 432 -> 666581432 ; 652 410 282 -> 652410282 ; 618 698 800 -> 618698800.",
    "- Exemple réellement tronqué : 1 003 207 03 -> 1003207030.",
    "- Exemple complet au-dessus de 1 milliard : 1 380 357 878 -> 1380357878 sans rien ajouter.",
    "",
