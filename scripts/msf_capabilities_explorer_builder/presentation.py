...
OPERATION_KINDS = {
    ...
    "stat_modifier": {"label": "Modifie une statistique", "order": 58},
    "stat_immunity": {"label": "Protège une statistique", "order": 58},
...
METRICS = {
    ...
    "technicalValuePct": "Valeur technique",
    "technicalMinValuePct": "Borne technique minimale",
    "technicalMaxValuePct": "Borne technique maximale",
