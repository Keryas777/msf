Voici les 2 fichiers complets avec les titres de graphiques remplacés dans le HTML et dans les title du JS.
...
<html lang="fr">
  <head>
    ...
    />
    <style>
      html.authChecking body { opacity: 0; pointer-events: none; }
    </style>
    <script>document.documentElement.classList.add("authChecking");</script>
    <script src="./auth-guard.js?v=2"></script>
    <meta name="theme-color" content="#0b0c0d" />
    <title>Graphiques de Guerre — Groupement</title>
    <link rel="stylesheet" href="./style.css" />
    <link rel="stylesheet" href="./war-graphs.css?v=ts" />
  ...
  <body>
    <div class="app">
      <header class="header">
        <button class="backBtn" type="button" aria-label="Retour">⬅️</button>
        <a href="./home.html" class="homeBtn" aria-label="Accueil">🏠</a>
        <div class="headerLeft">
          <h1 class="title">Graphiques de Guerre</h1>
          <p class="subtitle">Suivi joueur guerre après guerre, comparé à la moyenne de son alliance.</p>
        </div>
      </header>
      <section class="card controlsCard">
        <div class="controlGrid">
          <div class="field">
            ...
            <select id="allianceSelect" class="select" aria-label="Alliance">
          ...
          <div class="field">
            ...
            <select id="playerSelect" class="select" aria-label="Joueur"></select>
          </div>
          <div class="field field--range">
            <div class="rangeHeader">
              <span class="label">Affichage</span>
            </div>
            <div class="rangeChips" role="group" aria-label="Période affichée">
              <button
                class="rangeChip is-active"
                type="button"
                data-range="all"
                aria-pressed="true"
              >
      ...
      <section class="card playerSummaryCard">
        <div class="summaryTop">
          <div>
            <h2 class="cardTitle" id="playerTitle">—</h2>
            <div class="summarySub" id="playerSubtitle">Sélectionne un joueur.</div>
          </div>
          <div class="chipCount"><span id="warsCount">0</span></div>
        </div>
      ...
      <section class="chartGrid">
        <article class="card chartCard">
          <div class="chartHeader">
            <h2 class="cardTitle">📈 Note / 100 par GA</h2>
            <div class="chartLegend">
              <span><i class="legendPlayer"></i>Joueur</span>
              <span><i class="legendAlliance"></i>Moyenne</span>
            </div>
          </div>
          <div id="chartScore" class="chartMount"></div>
        </article>
        <article class="card chartCard">
          <div class="chartHeader">
            <h2 class="cardTitle">⚖️ Écart avec la note moyenne de l'alliance par GA</h2>
            <div class="chartLegend">
              <span><i class="legendPlayer"></i>Joueur</span>
              <span><i class="legendAlliance"></i>Moyenne</span>
            </div>
          </div>
          <div id="chartScoreGap" class="chartMount"></div>
        </article>
        <article class="card chartCard">
          <div class="chartHeader">
            <h2 class="cardTitle">⚔️ Attaques par GA</h2>
            <div class="chartLegend">
              <span><i class="legendPlayer"></i>Joueur</span>
              <span><i class="legendAlliance"></i>Moyenne</span>
            </div>
          </div>
          <div id="chartAttacks" class="chartMount"></div>
        </article>
        <article class="card chartCard">
          <div class="chartHeader">
            <h2 class="cardTitle">❌ Ratés par GA</h2>
            <div class="chartLegend">
              <span><i class="legendPlayer"></i>Joueur</span>
              <span><i class="legendAlliance"></i>Moyenne</span>
            </div>
          </div>
          <div id="chartMisses" class="chartMount"></div>
        </article>
        <article class="card chartCard">
          <div class="chartHeader">
            <h2 class="cardTitle">🎯 Pourcentage de Réussite par GA</h2>
            <div class="chartLegend">
              <span><i class="legendPlayer"></i>Joueur</span>
              <span><i class="legendAlliance"></i>Moyenne</span>
            </div>
          </div>
          <div id="chartSuccess" class="chartMount"></div>
        </article>
        <article class="card chartCard">
          <div class="chartHeader">
            <h2 class="cardTitle">🔥 Score d'impact / 35 par GA</h2>
            <div class="chartLegend">
              <span><i class="legendPlayer"></i>Joueur</span>
              <span><i class="legendAlliance"></i>Moyenne</span>
            </div>
          </div>
          <div id="chartImpact" class="chartMount"></div>
        </article>
        <article class="card chartCard">
          <div class="chartHeader">
            <h2 class="cardTitle">💥 Dégâts par GA</h2>
            <div class="chartLegend">
              <span><i class="legendPlayer"></i>Joueur</span>
              <span><i class="legendAlliance"></i>Moyenne</span>
            </div>
          </div>
          <div id="chartDamage" class="chartMount"></div>
        </article>
        <article class="card chartCard">
          <div class="chartHeader">
            <h2 class="cardTitle">🧨 Part des dégâts d'alliance par GA</h2>
            <div class="chartLegend">
              <span><i class="legendPlayer"></i>Joueur</span>
              <span><i class="legendAlliance"></i>Moyenne</span>
            </div>
          </div>
          <div id="chartDamageShare" class="chartMount"></div>
        </article>
        <article class="card chartCard">
          <div class="chartHeader">
            <h2 class="cardTitle">🛡️ Victoires défense par GA</h2>
            <div class="chartLegend">
              <span><i class="legendPlayer"></i>Joueur</span>
              <span><i class="legendAlliance"></i>Moyenne</span>
            </div>
          </div>
          <div id="chartDefenseWins" class="chartMount"></div>
        </article>
        <article class="card chartCard">
          <div class="chartHeader">
            <h2 class="cardTitle">🧲 Bonus défensif posé par GA</h2>
            <div class="chartLegend">
              <span><i class="legendPlayer"></i>Joueur</span>
              <span><i class="legendAlliance"></i>Moyenne</span>
            </div>
          </div>
          <div id="chartDeviations" class="chartMount"></div>
        </article>
      </section>
    </div>
    <script>
      (function () {
        ...
        s.src = "./war-graphs.js?v=" + Date.now();
        s.defer = true;
