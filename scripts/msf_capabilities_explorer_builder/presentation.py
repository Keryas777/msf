...
OPERATION_KINDS = {
    ...
    "barrier_apply": {"label": "Donne une Barrière", "order": 59},
    "barrier_remove": {"label": "Retire la Barrière", "order": 60},
...
METRICS = {
    ...
    "barrierHealthPct": "Barrière (% de vie max.)",
    "barrierRemovePct": "Barrière retirée (%)",
