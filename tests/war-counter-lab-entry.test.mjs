...
test("le labo charge l'entrée qui privilégie le Sheet direct", () => {
  assert.match(html, /war-counter-lab-entry\.js\?v=r7-entry-8/);
...
test("l'ancien module Vision reste chargé sans modifier son moteur", () => {
  assert.match(entry, /import\("\.\/war-counter-lab\.js\?v=r7-entry-8"\)/);
